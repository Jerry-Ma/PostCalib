...
PACKAGENAME = metadata.get('package_name', 'postcalib')
DESCRIPTION = metadata.get('description', 'A pipeline to post-process and stack WIYN ODI images')
AUTHOR = metadata.get('author', 'Zhiyuan Ma')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'zjerryma.com')
